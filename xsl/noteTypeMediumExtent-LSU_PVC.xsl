...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- splits physicalDescription/note @type="medium" into note and extent, in this collection field is not semicolon delimited -->
    ...
    <xsl:variable name="myRegEx" select="'([a-zA-Z\s,]+)\s?([0-9\sa-zA-Z]+)'"/>
